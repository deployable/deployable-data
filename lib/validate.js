...
class Validate {
  ...
  //    Validate.a('integer', 5, 'dollars') => true
  //    Validate.a('alpha', "qwertre4, 'username') => false
  ...
  // Add a new test, from json config
  static addTest(test_label, test_config){
    ...
    Validate._tests[test.label] = test
  }
