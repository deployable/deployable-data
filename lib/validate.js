...
module.exports = class Validate {
  ...
  static alphaMessage(string, name = 'Value'){
    if ( !Validate.alpha(string, name) ) {
      return `${name} is not alpha [ A-Z a-z ]`
    }
    return undefined
  }
  ...
  static numericMessage(string, name = 'Value'){
    if ( !Validate.numeric(string, name) ) {
      return `${name} is not numeric [ 0-9 ]`
    }
    return undefined
  }
  ...
  static alphaNumericMessage(string, name = 'Value'){
    if ( !Validate.alphaNumeric(string, name) ) {
      return `${name} is not alpha numeric [ A-Z a-z 0-9 ]`
    }
    return undefined
  }
  ...
  static alphaNumericError(string, name){
    ...
    if ( msg ) {
      let err = new ValidationError(msg, { test: 'alpha_numeric', value: string, name: name })
      return err
    }
    return undefined
  }
  ...
  static alphaNumericDashUnderscoreMessage(string, name = 'Value'){
    if ( !Validate.alphaNumeric(string, name) ) {
      return `${name} is not alpha numeric dash underscore [ A-Z a-z 0-9 _ - ]`
    }
    return undefined
  }
  ...
  static alphaNumericDashUnderscoreError(string, name){
    ...
    if ( msg ) {
      let err = new ValidationError(msg, { test: 'alpha_numeric_dash_underscore', value: string, name: name })
      return err
    }
    return undefined
  }
