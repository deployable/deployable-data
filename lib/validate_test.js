...
module.exports = class ValidateTest {
  ...
  set message(msg){
    if ( ! _.isString(msg) && ! _.isFunction(msg) ) 
      throw new Error(`The test "message" property must be a string or function, not a ${typeof msg}`)
    this._message = msg
  ...
  buildMessage( params = {} ){
    ...
    throw new Error(`Test "message" is of unknown type "${typeof this.message}`)
  }
